...
You will store `Customer` POJOs (Plain Old Java Objecgs) in a MongoDB database by using
Spring Data MongoDB.
...
* https://spring.io/gs/accessing-mongodb-data-rest[Accessing MongoDB Data with REST]
