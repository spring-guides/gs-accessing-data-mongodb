...
Below is the [initial Gradle build file](https://github.com/springframework-meta/gs-accessing-data-mongo/blob/master/initial/build.gradle). But you can also use Maven. The pom.xml file is included [right here](https://github.com/springframework-meta/gs-accessing-data-mongo/blob/master/initial/pom.xml).
...
Below are the Gradle steps, but if you are using Maven, you can find the updated pom.xml [right here](https://github.com/springframework-meta/gs-accessing-data-mongo/blob/master/complete/pom.xml) and build it by typing `mvn clean package`.
...
```
You can see the final version of `build.gradle` [right here]((https://github.com/springframework-meta/gs-accessing-data-mongo/blob/master/complete/build.gradle).
